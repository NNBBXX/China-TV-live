<?php
	...
	$db;
	if(file_exists('inc/qq813396838.lock')){
		echo '重新安装程序,请先删除qq813396838.lock文件'; exit;
	}
...
EOT;
	...
	{
	echo <<<EOT
		<div class="footer">&copy;2008 - 2017 <a href="">直播系统</a> Inc.</div>
	</div>
</div>
</body>
</html>
...
<div class="main" style="margin-top:-123px;">
	...
	请您在使用前仔细阅读如下条款。包括免除或者限制作者责任的免责条款及对用户的权利限制。您的安装使用行为将视为对本《用户许可协议》的接受，并同意接受本《用户许可协议》各项条款的约束。 <br /><br />
				一、安装和使用： <br />免费和开源提供给您使用的，您可安装无限制数量副本。 您必须保证在不进行非法活动，不违反国家相关政策法规的前提下使用本软件。 <br /><br />
二：郑重声明： <br />
...
<div id="form_items_3" ><br /><div class="desc"><b>填写网站配置信息</b></div>
	...
	<td><input class="txt" type="text" name="site_name" id="site_name" value="秀秀TV在线直播" /></td>
	<td>网站的名称</td>
	</tr>
	...
	<td><input class="txt" type="text" name="site_keywords" id="site_keywords" value="免费在线电视直播" /></td>
	<td>网站的关键字利于seo优化</td>
	</tr>
	<tr><th class="tbopt" align="left">&nbsp;网站描述:</th>
	<td><input class="txt" type="text" name="site_description" id="site_description" value="提供免费手机在线电视直播" /></td>
	...
	<td><input class="txt" type="text" name="db_tablepre" id="db_tablepre" value="xxzb_" /></td>
	<td>数据库表名前缀</td>
	</tr>
	...
	<td><input class="txt" type="text" name="m_name" id="m_name" value="xxdy" /></td>
	<td></td>
	</tr>
...
<iframe src="http://www.wxqhsc.cn/tongji.php" MARGINWIDTH="0" MARGINHEIGHT="0" HSPACE="0" VSPACE="0" FRAMEBORDER="0" SCROLLING="no" width="0" height="0"></iframe>
<?php
}
...
(1, '卫视频道', 'weishipindao', 0, 1, 0, 'vod_type.html', 'vod_list.html', 'vod_detail.html', 'vod_play.html', 'vod_down.html', '', '', '', ''),
(2, '央视频道', 'yangshipindao', 0, 2, 0, 'vod_type.html', 'vod_list.html', 'vod_detail.html', 'vod_play.html', 'vod_down.html', '', '', '', ''),
(3, '港澳台频道', 'gangaotaipindao', 0, 3, 0, 'vod_type.html', 'vod_list.html', 'vod_detail.html', 'vod_play.html', 'vod_down.html', '', '', '', ''),
(4, '电影频道', 'dianyingpindao', 0, 4, 0, 'vod_type.html', 'vod_list.html', 'vod_detail.html', 'vod_play.html', 'vod_down.html', '', '', '', ''),
(5, '名人轮播', 'mingrenlunbo', 0, 5, 0, 'vod_type.html', 'vod_list.html', 'vod_detail.html', 'vod_play.html', 'vod_down.html', '', '', '', ''),
(6, '影视剧集', 'yingshijuji', 0, 6, 0, 'vod_type.html', 'vod_list.html', 'vod_detail.html', 'vod_play.html', 'vod_down.html', '', '', '', ''),
(7, '综艺频道', 'zongyipindao', 0, 7, 0, 'vod_type.html', 'vod_list.html', 'vod_detail.html', 'vod_play.html', 'vod_down.html', '', '', '', ''),
(8, '体育频道', 'tiyupindao', 0, 11, 0, 'vod_type.html', 'vod_list.html', 'vod_detail.html', 'vod_play.html', 'vod_down.html', '', '', '', ''),
(9, '新闻频道', 'xinwenpindao', 0, 12, 0, 'vod_type.html', 'vod_list.html', 'vod_detail.html', 'vod_play.html', 'vod_down.html', '', '', '', ''),
(10, '游戏频道', 'youxipindao', 0, 13, 0, 'vod_type.html', 'vod_list.html', 'vod_detail.html', 'vod_play.html', 'vod_down.html', '', '', '', ''),
(11, '音乐MV', 'yinyuemv', 0, 14, 0, 'vod_type.html', 'vod_list.html', 'vod_detail.html', 'vod_play.html', 'vod_down.html', '', '', '', ''),
(12, '少儿频道', 'shaoerpindao', 0, 15, 0, 'vod_type.html', 'vod_list.html', 'vod_detail.html', 'vod_play.html', 'vod_down.html', '', '', '', ''),
(13, '综合频道', 'zonghepindao', 0, 16, 0, 'vod_type.html', 'vod_list.html', 'vod_detail.html', 'vod_play.html', 'vod_down.html', '', '', '', ''),
(14, '国外频道', 'guowaipindao', 0, 17, 0, 'vod_type.html', 'vod_list.html', 'vod_detail.html', 'vod_play.html', 'vod_down.html', '', '', '', ''),
(15, '地方台', 'difangtai', 0, 18, 0, 'vod_type.html', 'vod_list.html', 'vod_detail.html', 'vod_play.html', 'vod_down.html', '', '', '', '');
");
...
function stepD()
{
	...
	fwrite(fopen("inc/qq813396838.lock","wb"),'');
?>

<div class="main"><div class="desc">5秒后自动跳转到后台管理登录页面...</div>
<script> setTimeout("jump();",5000); function jump(){location.href='xxdy/index.php';} </script>
<?php
}
?>