var menu = {
	...
	"md":{"text":"频道","default":"vod","children":{"server":{"text":"服务器组","url":"?m=vod-server"},"player_config":{"text":"播放器","url":"?m=vod-player"},"vodtype":{"text":"频道分类","url":"?m=vod-type"},"vodclass":{"text":"剧情分类","url":"?m=vod-class"},"vodtopic":{"text":"频道专题","url":"?m=vod-topic"},"vodrepeat":{"text":"检测重复数据","url":"?m=vod-list-repeat-ok"},"vod":{"text":"频道管理","url":"?m=vod-list"},"vodadd":{"text":"添加频道","url":"?m=vod-info"} }},
	...
	"mi":{"text":"更新","default":"maccj","children":{"maccj":{"text":"一键更新","url":"?m=collect-union"},"ds":{"text":"","url":"?m=collect-ds"} }},
