...
elseif($method=='play')
{
	...
	if(!empty($password)){
if($GLOBALS['MAC']['app']['wxpass']=0 && is_weixin())
		{}
else if($_POST['password'] !== $password)  {
			   exit("<!DOCTYPE html><html lang='zh-CN'><head><meta http-equiv='Content-Type' content='text/html; charset=UTF-8'><meta http-equiv='X-UA-Compatible' content='IE=edge'><meta name='viewport' content='width=device-width, initial-scale=1'><title>关注后永久免费观看</title></head><body leftmargin='0' topmargin='0'><center><div style='width:300px;height:150px;border:1px solid #3374b4;margin-top:100px;'><div style='padding:10px;font-size:14px;color:#fff;background:#3374b4;'><b>请输入视频播放口令后继续！</b></div><div style='font-size:10pt;background:#ffffff'><br /><br /><form action='' method='post'>播放口令：<input style='border:1px solid #3374b4;height:33px;line-height:33px;padding-left:5px' type='password' name='password' /> <input style='border:1px solid #3374b4;background:#3374b4;padding:7px 10px;color:#fff;text-decoration:none;vertical-align:top' type='submit' value='播 放' /></form></div></div><img style='margin:15px 0 5px 0' src='/wx.png' height='250' width='250'><br/>扫描二维码关注微信公众号<br />回复<font color='red'>频道名</font>获取播放口令</center></body></html>");
		}
	}		
