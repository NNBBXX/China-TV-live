...
class AppTpl
{
            ...
            case "topic":
            	switch($m2)
				{
                    ...
                    case "pic":
                    	...
                    	}elseif($GLOBALS['MAC']['app']['quanju']>0 && strpos(",".$val,"npimg")<=0){
						$val = "npimg.php?pic=".$mrs["t_pic"];
                    	}
                    	break;
                    case "count":
            ...
            case "vod":
                ...
                switch($m2)
                {
                    ...
                    case "picthumb":
						...
						$val = "npimg.php?pic=".$mrs["d_picthumb"];
                        }
                        break;
                    case "picslide":
                    	$val = $mrs["d_picslide"];
						...
						$val = "npimg.php?pic=".$mrs["d_picslide"];
                        }
                        break;
    ...
    function getUrlInfo($flag)
	{
		...
		else if ($GLOBALS['MAC']['app']['encrypt'] == 3){
			require_once 'zyjm.php';//引用加密文件
		}
	    else{
	        $url = "'".$url."';";
		}
