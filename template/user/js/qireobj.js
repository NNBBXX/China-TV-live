...
jQuery.showfloatdiv = function(ox) {
	...
	if (oxdefaults.wantclose == 1) {
		var floatdiv = $('<div class="maopoubox-overlayBG" id="maopoubox_overlay"></div><div id="maopoubox" class="maopoubox png-img"><iframe frameborder="0" class="ui-iframe"></iframe><table class="ui-dialog-box"><tr><td><div class="ui-dialog"><div class="ui-dialog-cnt" id="ui-dialog-cnt"><div class="ui-dialog-tip alert" id="ui-cnt"><span id="xtip">'
				+ oxdefaults.txt
		...
		var floatdiv = $('<div class="maopoubox_overlayBG" id="maopoubox_overlay"></div><div id="maopoubox" class="maopoubox"><iframe frameborder="0" class="ui-iframe"></iframe><div class="ui-dialog"><div class="ui-dialog-cnt" id="ui-dialog-cnt"><div class="ui-dialog-box"<div class="ui-cnt" id="ui-cnt">'
				+ oxdefaults.txt + '</div></div></div></div></div>');
		$("body").append(floatdiv);
		$("#maopoubox_overlay").fadeIn(500);
		$("#maopoubox").fadeIn(500);
	}
	$('#maopoubox_overlay').bind('click', function(e) {
		$.closefloatdiv(e);
		if (pp != null) {
			clearTimeout(pp);
		}
